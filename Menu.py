...
class Snake:
    def __init__(self):
        ...
        self.Mc_sound = pygame.mixer.Sound('Sound\\Minecraft.mp3')
        self.mm_sound = pygame.mixer.Sound('Sound\\Mmm.mp3')
...
class MAIN:
    ...
    def increasespeed(self):
        ...
        pygame.time.set_timer(SCREEN_UPDATE, snake_speed - self.speed)
